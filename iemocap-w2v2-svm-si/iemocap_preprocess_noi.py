# IEMOCAP extraction for aug_noi
# usage: python iemocap_preprocess_ir.py /path/to/IEMOCAP_full_release/aug_noi
        ...
        for label_path in label_paths:
            ...
            with open(path_join(label_dir, label_path)) as f:
                for line in f:
                    ...
                    meta_data.append({
                        'path': wav_paths[line[1]+'_imp'], #_imp or _noi
